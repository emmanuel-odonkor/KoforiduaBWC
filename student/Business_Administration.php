            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">BA-Business Administration Tutors <span class="fa fa-chalkboard-teacher"></span></h1>
                        <hr />
                        <div class="jumbotron">
            <?php 
             ...
             $sql="SELECT * FROM `tutors` WHERE `department` = 'BA-Business Administration'";
