...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Find Resources</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Find Resources <span class="fa fa-chalkboard-teacher"></span></h1>
                        <div class="jumbotron">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="small text-white stretched-link" href="Lib_arts.php"></a>
                        ...
                        <div class="jumbotron">
                            <h3>Choose the Department type</h3>
                            <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="ENG.php"></a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="CSIS.php"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="BA.php"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="HSS.php"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
