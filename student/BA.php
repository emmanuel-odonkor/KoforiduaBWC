    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Business Administration Resources<span class="fa fa-eye"></span></h1>
            ...
            <?php 
             ...
             $sql="SELECT `resource_topic`,`resource_category`,`resource_file` FROM `resources` WHERE `resource_category` = 'BA-Business Administration'";
