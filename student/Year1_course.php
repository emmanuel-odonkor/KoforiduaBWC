<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $transport = (new Swift_SmtpTransport('smtp.gmail.com', 'tls'))
          ->setUsername('odonkore41@gmail.com')
          ->setPassword('spartan123A')
        ;
        ...
        $message = (new Swift_Message($_POST['subject']))
          ->setFrom([$_POST['s_email']])
          ->setTo([$_POST['t_email']])
          ->setBody('Name: '.$_POST['name'].'<br /> Message'.$_POST['message'],'text/html')
          ;
        ...
        if(!result){
            ...
            $msg = "<strong>Email not sent</strong>";
        }else{
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Year 1 Course Tutors <span class="fa fa-chalkboard-teacher"></span></h1>
                        <hr />
                        <div class="jumbotron">
            <?php 
             ...
             $sql="SELECT * FROM `tutors` WHERE `course_year` = 'Year_1'";
                    ...
                    <div class="card w-500" style="background-color:#923D41; color: white;">
                        ...
                        else 
                        {
                            echo "<center><div class='alert alert-danger' style='font-size:16px;'>
                                              <strong>Sorry!</strong> No Tutor registered for a course taught in this year
                                           </div></center>";
                        }
             ...
             ?>
                ...
                <a href="Year1_course.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> Year 1 Course Tutors</button></a>
                <a href="Year2_course.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> Year 2 Course Tutors</button></a>
                <a href="Year3_course.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> Year 3 Course Tutors</button></a>
                <a href="Year4_course.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> Year 4 Course Tutors</button></a>
            </div>
                    </div>
