    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">HSS-Humanities and Social Sciences -- Evaluation <span class="fa fa-star"></span></h3>
                        <hr />
                        <div class="jumbotron">
            <?php 
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST")
             ...
             $sql="SELECT * FROM `tutors` WHERE `department` = 'HSS-Humanities and Social Sciences'";
