            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">CSIS-Computer Science and Information Systems -- Evaluation <span class="fa fa-star"></span></h3>
                        <hr />
                        <div class="jumbotron">
            <?php 
                                        ...
                                        rules: {
                                            ...
                                            <form name="frmRating" id="frmRating" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="txtComment" id="txtComment" class="form-control" rows="2" placeholder="Comment on Tutor performance" required></textarea>
                                                </div>
