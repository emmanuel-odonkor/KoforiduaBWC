                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #923D41;">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="nav" >
                            <br />
                            <br />
                            <div class="sb-sidenav-menu-heading">Managment System</div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Find Tutor <span class="fa fa-chalkboard-teacher"></span></h1>
                        <div class="jumbotron">
                            <h3>Tutors for Liberal Arts Courses</h3>
                            <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="small text-white stretched-link" href="Liberal_arts.php"></a>
                        ...
                        <div class="jumbotron">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="Engineering.php"></a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="Computer_science.php"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="Business_Administration.php"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-building"></i>
                                        <a class="small text-white stretched-link" href="Humanities_Social_Science.php"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <hr style=" border:1px solid #923D41; "/>
                        <div class="jumbotron">
                            <h3>Tutoring Course Year</h3>
                            <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    <div class="card-body">Year 1 Courses</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-book-open"></i>
                                        <a class="small text-white stretched-link" href="Year1_course.php"></a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    <div class="card-body">Year 2 Courses </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-book-open"></i>
                                        <a class="small text-white stretched-link" href="Year2_course.php"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;" >
                                    <div class="card-body">Year 3 Courses </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-book-open"></i>
                                        <a class="small text-white stretched-link" href="Year3_course.php"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card text-white h-100" style="background-color: #923D41;">
                                    <div class="card-body">Year 4 Courses </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <i class="fas fa-book-open"></i>
                                        <a class="small text-white stretched-link" href="Year4_course.php"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
