    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">CSIS-Computer Science and Information Systems Tutors <span class="fa fa-chalkboard-teacher"></span></h3>
            ...
            <?php 
             ...
             $sql="SELECT * FROM `tutors` WHERE `department` = 'CSIS-Computer Science and Information Systems'";
             ...
             ?>
                ...
                <a href="Engineering.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> ENG-Department</button></a>
                <a href="Computer_science.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> CSIS-Department</button></a>
                <a href="Business_Administration.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> BA-Department</button></a>
                <a href="Humanities_Social_Science.php"><button class="btn btn-secondary" style="width: 130px; background-color:#923D41;"><span class="fas fa-chalkboard-teacher"></span> HSS-Department</button></a>
            </div>
                    </div>
