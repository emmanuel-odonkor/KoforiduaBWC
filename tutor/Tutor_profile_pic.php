...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Set Tutor Picture</title>
            ...
            <div id="layoutSidenav_content" >
                <main>
                    <?php
                        ...
                        $sql= "UPDATE `tutors` SET `profile_pic` = '$filename' WHERE `usertutor_id` = '$id'";
                        $qry = mysqli_query($conn, $sql);
                        if( $qry) {
                        echo "<center><div class='alert alert-success' style='font-size:16px;'>
                        <strong>Success!</strong> Profile Photo Uploaded Successfully. Click to <a href='Tutor_profile.php'>view</a> Profile Photo
                     </div></center>";
                        }
                        else{
                            echo "<center><div class='alert alert-danger' style='font-size:16px;'>
                        <strong>Sorry!</strong> Failed to upload Profile Photo
                     </div></center>";
                        }
                        }
                    ...
                    <div class="container-fluid" style="width:600px;">
                        <h1 class="mt-4">Setting Tutor Profile Picture <span class="fa fa-user"></span></h1>
                        <hr >
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control " name="uploadfile" style="font-size: 16px;" style="width: 200px;" value="">
                                                    </div>
                                                </div>
