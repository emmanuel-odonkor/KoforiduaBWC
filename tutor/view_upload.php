...
<html lang="en">
    <head>
        ...
        <title>Dashboard - View Uploads</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Resources Uploaded <span class="fa fa-eye"></span></h1>
            ...
            <?php 
             ...
             $sql="SELECT `resource_topic`,`resource_category`,`resource_file` FROM `resources` WHERE `tutorresource_id` = '$tutor_id'";
                ...
                ';
                        ...
                        else 
                        {
                            echo "<center><div class='alert alert-danger' style='font-size:16px;'>
                                              <strong>Sorry!</strong> You have not uploaded a resource
                                           </div></center>";
                        }
             ...
             ?>
                ...
                <a href="Tutor.php"><button class="btn btn-secondary" style="color:#923D41; background-color: white; border:2px solid #923D41; text-decoration: none;  "><span class="fas fa-arrow-left"></span> Back</button></a>
            </div>
                    </div>
